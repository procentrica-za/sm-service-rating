...
func (s *Server) handlegetbuyerdashboard() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		//get userID from crud service
		req, respErr := http.Get("http://" + config.CRUDHost + ":" + config.CRUDPort + "/buyer?userid=" + userid)
...
func (s *Server) handlegetsellerdashboard() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		//get userID from crud service
		req, respErr := http.Get("http://" + config.CRUDHost + ":" + config.CRUDPort + "/seller?userid=" + userid)
